...
<body>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            ...
            <div class="center">        
                ...
                <p class="lead">If You Have Any Queries Regarding Any Course,Contact Us!</p>
            </div> 
            <div class="row contact-wrap"> 
                ...
                <form id="main-contact-form" class="contact-form" name="contact-form">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-group">
                                <asp:Button ID="Button2" class="btn btn-primary btn-lg" OnClick="Button2_Click" runat="server" Text="Submit Message"></asp:Button>
    ...
    <!--/#contact-page-->
     ...
     <br /> <br />  
        <div class="center">                
            ...
            <p class="lead"> SIIT offers you courses to get you job ready..Get In Touch! </p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-5 text-center">
                        <div class="gmap">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.1017309163544!2d77.13373931508251!3d28.626712982420116!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d03300a33a431%3A0xf5f7f2c4f7e8ad90!2sChhaya+Infosystems!5e0!3m2!1sen!2sin!4v1489141415828" width="600" height="450" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" style="border:0" allowfullscreen></iframe>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-7 map-content">
                        <ul class="row">
                            <li class="col-sm-6">
                                ...
                                <address>
                                    <p>We are Happily available at <br /><b> +91 9650-777-567 </b></p>
                                     <p>Between <b> 9 Am to 8 PM Every Monday to Saturday</b></p>
                                </address>
                                <address>
                                    <h4>Head Office</h4>
                                    <p>SHRI Institute Of Information Technology <br>
                                    A-17, B2 Naraina Vihar Main Road<br />
                                        Near SBI, New Delhi-110028
                                    </p>
                                    <p>Phone :<b> 011-41414663</b> <br>
                                        Mobile :<b> +91 9650-777-567</b><br />
                                    Email Address : <b> shriinformation@gmail.com</b></p>
                                </address>
                            ...
                            <li class="col-sm-6">
                                ...
                                <address>
                                    <p> Powered By : <h4> Chhaya Infosystems </h4>                                   
                                    </p>
                                    </address>
                                <address>
                                    <p> Associated By : <h4> PcLeLo.com </h4>                                        
                                    </p>
                                    </address>
                                <br />
                                <br />
                                <address>
                                   <p> For any Escalation,<br /> Please call <b> +91 9811959469 </b></p>
                               </address>
                            </li>
                        </ul>
                    </div>
