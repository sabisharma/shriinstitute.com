<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Computer_basic.aspx.cs" Inherits="Computer_basic" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Computer Basic Courses &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p>Basic Computer Course is the Basic of the course is to impart basic level computer appreciation programme with more emphasis on hands on training. Initially, the course was conceived as to boost the concept of introducing a course on computer fundamentals, especially for students and for all who donot know a bit about computer. However, the course has gained popularity amongst many more categories. The programme can equip a person to use the computers in day-to-day life for professional and personal use.
                            <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's to learn computer which have no <br />
                                        computer background. </font></li>
                                    ...
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this Basic Computer Course you will 
                        ...
                        <div class="progress-wrap">
                            <h3>Compter Basic Courses Under Demand</h3>
                            <div class="progress">
                        ...
                        <div class="panel-group" id="accordion1">
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  Microsoft Office is a collection of software programs commonly used in an office environment.In SIIT Basic Computer Courses, We only teaches Microsoft Word, Excel, and PowerPoint. And with that you can easily done :
