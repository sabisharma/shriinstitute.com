<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Spcl_Courses.aspx.cs" Inherits="Spcl_Courses" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Special Courses &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p><br />
                           SIIT institute program different courses on request.Learning new technologies like computer basic, mobile apps etc. are now easier under this special courses. Using new technologies is easier once you learn the basics. This courses are for kids, Senior Citizens, Housewives and For All.<br />
                          <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's to learn new technologies. Using new technologies is easier once you learn the basics.</font></li>
                                    ...
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this you can step-up with the new advance technology world and might be easy to use all technologies.</font></li>
                                </ul>
                         </p>

                        <div class="progress-wrap">
                            <h3>Special Courses Under Demand</h3>
                            <div class="progress">
                        ...
                        <div class="panel-group" id="accordion1">
                              ...
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                        ...
                                        <div class="media-body">
                                             <p><br />
                                                 We all know today, we are living in a modern scentific era where technolgies are advancer day-by-day to step up with this we all want to learn new technologies.SIIT offers you how to use a computer, how to use a android phone, how to use mobile apps, download files, images, video from Interenet. Because many people do not exactly know how to use new techhnology.
                                               </p>
                                        </div>
                                  </div>
                              </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseTwo1" class="panel-collapse collapse">
                              <div class="panel-body">
                                     <div class="media-body">
                               SIIT offers a  special courses for senior citizen in this, we teaches how to use day-to-day technolgies like how to use a computer, how to use a android phone, how to use mobile apps, download files, images, video from Interenet and many more. We need o learn basic first before we step-out with real world. Because many senior citizen fails to know how to use new techhnology.
                                 </div>
                            </div>
                          </div>
                              </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                               Mostly parents worried about their kids "how he/she step-out with real advancer world". So SIIT offers you learn computers with funs for kids only.How to use a computer to solve real world problems.Using new technologies is easier once you learn the basics.
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseFour1" class="panel-collapse collapse">
                              <div class="panel-body">
                                   ...
                                   SIIT offers a  special courses for house-wives in this, we teaches how to use day-to-day technolgies like how to use a computer, how to use a android phone, how to use mobile apps, download files, images, video from Interenet and many more. We need o learn basic first before we step-out with real world. Because many illterate housewives fails to know how to use new techhnology.
                                   </div>
                            </div>
                          </div>
