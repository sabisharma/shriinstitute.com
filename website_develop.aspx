<%@ Page Language="C#" AutoEventWireup="true" CodeFile="website_develop.aspx.cs" Inherits="website_develop" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Website Development Courses &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p><br />
                           SIIT Web Designing Courses basically deals with creation and maintenance of websites.All those web pages which we see on Google, Yahoo are created by Web Designers.This courses mainly focuses on the core area of necessary for creation of Websites from the one you chose like XHTML, Javascript, CSS, .NET, PHP.Student by the end of the courses know how to create web-site, how to maintain the same along with adding animations and effects.<br />
                          <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's to learn Website Development.</font></li>
                                    <li><font style="color: #FF3300"  >Course Duration :</font><font style="color: #CBCBCB"> 3 Months. </font></li>
                                    <li><font style="color: #FF3300"  >Class Mode :</font><font style="color: #CBCBCB"> Regular & Alternate. </font></li>
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this course, you will be ready to join top national & international IT companies and can also create your own website.</font></li>
                                </ul>
                         </p>

                        <div class="progress-wrap">
                            <h3>Website Development Courses Under Demand</h3>
                            <div class="progress">
                        ...
                        <div class="panel-group" id="accordion1">
                          <div class="panel panel-default">
                            <div class="panel-heading active">
                              <h3 class="panel-title">
                                ...
                                1:  Web Fundamentals and Graphics
                              ...
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                        ...
                                        <div class="media-body">
                                             <p><br />
                                                 SIIT teaches you about web fundamentals, web technologies, web designing industry, types of websites, history of web, protocols, internet etc. It will help you in exploring your area of interest.Web Graphics, it is very useful for creating stunning user interface designs. We know very well that user interface is the key of success for any website or portal and without sound knowledge of the basics of designing and design principles one can't create a professional user interface for a website. Our experienced mentors will focus on these areas too.
                                                  <br />
                                               </p>
                                        </div>
                                  </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              ...
                              2: Web Designing and Interactivity
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                            <div id="collapseTwo1" class="panel-collapse collapse">
                              <div class="panel-body">
                                     <div class="media-body">
                                   The real show starts with the leading web technologies such as HTML, CSS, JavaScript, PhP, .NET. This part of training will reveal all possible technologies that help in creating websites. We will focus on various topics including HTML5, CSS3, JavaScript, DHTML, HTML5 DOM, jQuery, Ajax, JSON etc.
                               We do not teach you how to make a website only but also teach you the techniques to create a professional level web portal. We will tell you how to create a complete cross-browser website, how to deal with animations on website, and creation of eye catchy effects using CSS3 and JavaScript.
                               Our institute takes pain in developing student's career as we are equally concerned about students' future, that's why we give them all the possible knowledge related to their subjects at fullest.
                                 </div>
                            </div>
                          </div>
                              </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  Website today is dynamic or uses server-side languages. So, let's start with world's most powerful server side scripting language like PHP, ASP.NET. We will teach you how to create and integrate databases successfully to the website.Industry prefers accurate and productive ways to fulfill their clients demand. If one codes a site manually then it takes weeks or months.
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h3 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseFour1">
                                   4: Website Promotion, Maintenance, and Customizations
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                            <div id="collapseFour1" class="panel-collapse collapse">
                              <div class="panel-body">
                             Actually real responsibilities takes place when you finish the web design and development work. We will share knowledge of web management, web promotion, website optimization, and web customizations with you. After this course you can test and validate a website using various validation tools so that you can assure the quality and code structure of the website. 
                                  This topic summarizes all the essential tips to upload and maintain a website. We will also train you for cPanel management, which means you would be able to create FTP accounts, manage website performance, and create error pages for your website.
                                   </div>
                            </div>
                          </div>
