<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Livnet.aspx.cs" Inherits="Livnet" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Live Project Networking Training &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p><br />
                           SIIT institute teaches students with comprehensive knowledge to plan, secure, maintain and even troubleshoot various enterprise networks LIVE. We have set up higher standards to deliver the best computer networking course.The basic reason of having students undergo this kind of LIVE training is for students to experience what a real networking environment should be.Real experience of executing a project under the expert guidance. 
                            <br /
                                <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's to learn Networking.</font></li>
                                    ...
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this Networking Course you can<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; work as a network engineer, network operations head, network security <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; specialist, security administrators, support engineers, etc.</font></li>
                                </ul>
                         </p>

                        <div class="progress-wrap">
                            <h3>Networking Courses Under Demand</h3>
                            <div class="progress">
                              <div class="progress-bar color3" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
                                <span class="bar-width">82%</span>
                              </div><br />
                                <br /><center>
                        ...
                        <div class="panel-group" id="accordion1">
                          <div class="panel panel-default">
                            <div class="panel-heading active">
                              <h3 class="panel-title">
                                ...
                                1: Network Basic, Wireless and Wired Connections
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseTwo1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  <ul>
                                      <li>Overview Of Security Concept</li>
                                      <li>VPN(virtual private network)</li>
                                      <li>Secure Routing Switching</li>
                                      <li>Cisco Firewall Technologies</li>
                                      <li>IPS(Intrusion Prevention System)</li>
                                      <li>Content and Endpoint Security</li>
                                    </ul>
                            </div>
                          </div>
                              </div>
                           ...
                           <div class="panel-heading">
                              <h3 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseThree1">
                                 3: Network Access Control & Monitoring
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                 We Teaches under as this are :
                                  <ul>
                                      <li>Network Access Control (NAC) is a computer networking solution that uses a set of protocols to define and implement a policy that describes how to secure access to network nodes by devices when they initially attempt to access the network.</li>
                                      <li>The course of Network Monitoring from SIIT covers advanced modules: remote plug-in executors, NSClient++, email notifications, Nagios plug-in development and event handlers. This course is necessary to every network administrator.</li>
                                  </ul>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseFour1" class="panel-collapse collapse">
                              <div class="panel-body">
                           In SIIT, we teachs you detsails Windows Server 2008 includes many tools for troubleshooting and testing TCP/IP connectivity. Under the practical session looks at automated diagnostics, basic tests that you should perform whenever you install or modify a computer's network settings, and techniques for resolving difficult networking problems involving DHCP and DNS. The final module shows you how to perform detailed network diagnostics testing.
                              </div>
                            </div>
                          </div>
