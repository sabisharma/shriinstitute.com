<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hardware.aspx.cs" Inherits="Hardware" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Hardware Courses &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p><br />
                           SIIT institute is the best one in giving the professional Hardware training . Our training institute is offering complete practical based hardware training with our highly qualified hardware trainers. SIIT Hardware Courses covers all fundamental of part of , we also believe in giving high-end & finishing classes for student. We are leading & most popular institute to build professionals Hardware experts, who are service his/her services in national & international companies. This course is perfect for those people who want to do own wok as a freelancer.
                            <br /
                                <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's to learn Computer Hardware.</font></li>
                                    ...
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this Hardware Course you<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        get in-depth knowledge of understanding the Hardware of Computers.</font></li>
                                </ul>
                         </p>

                        <div class="progress-wrap">
                            <h3>Hardware Courses Under Demand</h3>
                            <div class="progress">
                        ...
                        <div class="panel-group" id="accordion1">
                          <div class="panel panel-default">
                            <div class="panel-heading active">
                              <h3 class="panel-title">
                                ...
                                1: Fundamentals & Pc hardware support skills
                              ...
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                        ...
                                        <div class="media-body">
                                             <p><br />
                                               SIIT teaches a Computer Hardware fundamentals and the basic PC and Laptop hardware as a basic level 1 and advance 3 month course. It put emphasis on practical training in identification, assembling, dissembling, repairing and configuring computer systems. SIIT keeps the training methodology simple yet effective. Hands-on training is given to the students in the practical lab during computer hardware course.<br /> </p>
                                        </div>
                                  </div>
                              </div>
                            </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              ...
                              2: Understanding Motherboards and other hardwares
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                            <div id="collapseTwo1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  In Computer Hardware courses, SIIT teachers teaches you from the basic motherboard details to the advance level and other depth details of computer hardware which is very useful to the students who are enrolling Computer Hardware Advance.</div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h3 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseThree1">
                                 3: Assembling-Disassembling Desktops and Laptops
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  <ul>
                                      <li> The assembling of the computer system is exactly the opposite of disassembling operation.Before Starting assembling the computer system, SIIT teaches the basic details of plugs, socket , ports etc. and very useful SIIT hardware notes and  practical classes.</li>
                                      <li>The disassembling of the computer system is exactly the opposite of assembling operation.Before Starting disassembling the computer system, SIIT teaches you how to disassemble Computer hardware and by given SIIT hardware notes and  practical classes.</li>
                                  </ul>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h3 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseFour1">
                                   4: Troubleshooting Desktops and Laptops
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                            <div id="collapseFour1" class="panel-collapse collapse">
                              <div class="panel-body">
                             <ul>
                                 <li>Hardware Problem – Dead Condition, Display Not Working etc.</li>
                                <li>Software Problem – Software not working, Corrupted Software, VIRUS detection & removal, Detection issues etc. </li>
                                 <li>Troubleshoot each part of Desktops & Laptops uniquely.</li>
