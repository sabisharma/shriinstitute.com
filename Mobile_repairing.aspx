<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mobile_repairing.aspx.cs" Inherits="Mobile_repairing" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Mobile Repairing Courses &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p><br />
                           SIIT institute offers this course to designed and build up the capacity of self-employment in the field of mobile handset repairing. The course includes Generations of mobile phones, components used in mobile handsets, mobile phone hardware troubleshooting (water damage, hang, charging problems, network problems, power failure, keypad problems etc.), installation of software, flashing, use of secret codes, PC based diagnostic tools.
                            <br /
                                <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's to learn Mobile Repairing.</font></li>
                                    ...
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this Mobile Repairing Course <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        you get in-depth knowledge of understanding and repairing the different<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; mobiles.</font></li>
                                </ul>
                         </p>

                        <div class="progress-wrap">
                            <h3>Mobile Repairing Courses Under Demand</h3>
                            <div class="progress">
                        ...
                        <div class="panel-group" id="accordion1">
                          <div class="panel panel-default">
                            <div class="panel-heading active">
                              <h3 class="panel-title">
                                ...
                                1: Overview of Mobile Phone & Chip Level Training
                              ...
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                        ...
                                        <div class="media-body">
                                             <p><br />
                                                 <ul>
                                                     <li>History of Mobile Phone</li>
                                                     <li>GSM & CDMA Structure & Generation of mobile phone</li>
                                                     <li>Electronic Components Overview</li>
                                                     <li>GPRS, Bluetooth, Infrared</li>
                                                     <li>Frequency & Channels</li>
                                                     <li>Mobile Phone Assembly & Disassembly</li>
                                                     <li>Chip Level Soldering De-soldering</li>
                                                 </ul>
                                        </div>
                                  </div>
                              </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseTwo1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  <ul>
                                      <li>Parts of Computer/Computer Operating</li>
                                      <li>Driver Installation</li>
                                      <li>Mobile Phone S/W Repairing with coding</li>
                                      <li>All Type Of Unlocking – User Lock, SIM/Country Lock</li>
                                      <li>Online IMEI Repairing</li>
                                      <li>File Flashing, Set Dead, On/Off, Hang, Restart etc.</li>
                                      <li>Repairing All Type of Software Problem</li>
                                    </ul>
                            </div>
                          </div>
                              </div>
                           ...
                           <div class="panel-heading">
                              <h3 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseThree1">
                                 3: Mobile Phone Electronics & Hardware Repairing
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  <ul>
                                      ...
                                      <li>Charge/Voltage/Types of Current</li>
                                      <li>All Electronics Components Identification testing & their working</li>
                                      <li>Basic Tips for Mobile Phone Hardware Repairing</li>
                                      <li>Section of Mobile Phone/Circuit Diagram Reading</li>
                                      <li>GSM/CDMA/Chinese Mobile Phone Troubleshooting</li>
                                  </ul>                                  
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h3 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseFour1">
                                   4: Advance H/W & S/W Mobile Repairing Section
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                            <div id="collapseFour1" class="panel-collapse collapse">
                             ...
                             <ul>
                                ...
                                <li>Fault & Finding.</li>
                                 <li>GPRS System & Wi-Fi System.</li>
                                 <li>Assembling & Disassembling of Smart Phone</li>
                                 <li>Phone Upgrading, Jail Break, Country Unlock.</li>
                                 <li>Android Phone root, Pattern lock, flashing.</li>
                                 <li>Blackberry Lock, Flashing Map Problem</li>
                                 <li>Smart Phone Internet Connectivity.</li>
                                 <li>Wi-Fi Connectivity in Blackberry</li>
                             </ul>
                              </div>
                            </div>
                          </div>
