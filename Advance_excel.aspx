<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Advance_excel.aspx.cs" Inherits="Advance_excel" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Advance Excel Courses &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p><br />
                           SIIT institute Advance Excel program is designed for executives who are already familiar with the basics of Microsoft Excel, and who would like to work with more advanced features of Microsoft Excel that help in improving their efficiency of working with worksheets, analyzing data, creating MIS reports, and automating various tasks.<br />
                          <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's to learn Advance Excel.</font></li>
                                    ...
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this Advance Excel Course you will be considered a strong and competent Excel professional.</font></li>
                                </ul>
                         </p>

                        <div class="progress-wrap">
                            <h3>Advance Excel Courses Under Demand</h3>
                            <div class="progress">
                        ...
                        <div class="panel-group" id="accordion1">
                                        ...
                                        <div class="media-body">
                                             <p><br />
                                                 <ul>
                                                     ...
                                                     <li>Creating, editing, saving and printing spreadsheets.</li>
                                                     <li>Working with functions & formulae.</li>
                                                     <li>Graphically representing data : Charts & Graphs.</li>
                                                     <li>Analyzing data : Data Menu, Subtotal, Filtering Data.</li>
                                                     <li>Formatting worksheets , Securing & Protecting spreadsheets.</li>
                                                 </ul>
                                                  <br />
                                               </p>
                                        </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseTwo1" class="panel-collapse collapse">
                              <div class="panel-body">
                                     <div class="media-body">
                                  <ul>
                                      <li>Use the Function Wizard, Common functions (AVERAGE, MIN, MAX, COUNT,COUNTA, ROUND, INT) etc.</li>
                                      <li>Nested functions , Name cells /ranges /constants.</li>
                                      <li>Relative, Absolute, Mixed cell references : >,<,= operators.</li>
                                      <li>Logical functions using IF, AND, OR, NOT.</li>
                                      <li>The LOOKUP function , Date and time functions , Annotating formulas.</li>
                                      <li>Definition and use , Record a macro.</li>
                                  </ul>
                                 </div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  <ul>
                                      <li>  Sub Total Reports, Auto Filter and more..</li>
                                      <li>Password Protecting Worksheets.</li>
                                      <li>Functions:- LOOKUP, VLOOKUP, HLOOKUP,  COUNTIF, SUMIF and more..</li>
                                      <li>What-if-analysis, GOAL SEEK.</li>
                                      <li>PIVOT Tables, NESTED IF.</li>
                                      <li>Reporting.</li>
                                      <li>Consolidation of Data.</li>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseFour1" class="panel-collapse collapse">
                              <div class="panel-body">
                             <ul>
                                 <li>Create charts , Enhance charts, Drawing toolbar features and more..</li>
                                 <li>Use multiple windows : Copy/ paste between Worksheets.</li>
                                 <li>Link worksheets , Consolidate worksheets. </li>
                                 <li>Print features : Create /edit an outline.</li>
                              </ul>
                                   </div>
                            </div>
                          </div>
