  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About CCC (Course on Computer Concepts) &nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p>CCC is Government Certificate Course designed to impart knowledge at a basic level in computers for the common man. Benefits: On successful completion of the course, the incumbent is enabled to use a computer for basic purposes of preparing personal/business letters, viewing information on Internet (the Web), sending mails, preparing business presentations.Government Doeacc/Nielit CCC Certificate can be used in all the government job purpose.                            <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's do that course to make your resume more strong for government job.<br /></font></li>
                                    ...
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this CCC Course you will equipped with all knowledge of computer working which can be used personally or in official working. </font></li>
                                </ul>
                         </p>

                        <div class="progress-wrap">
                            <h3>CCC Under Demand</h3>
                            <div class="progress">
                        ...
                        <div class="panel-group" id="accordion1">
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseTwo1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  <ul>
                                      <li>Microsoft Paint or 'MS Paint' is a basic graphics/painting utility that is included in all the Microsoft Windows versions.MS Paint can be used to draw, colour and edit pictures, including imported pictures from a digital camera for example.It can save creations in standard formats such as .jpg and .bmp.</li>
                                      <li> WordPad is a Microsoft Windows program that you can use to create documents such as letters, notes and posters. It's less complicated than a full word processor but still lets you perform a range of tasks:create, open, and save documents, format documents – that is, change the size and style of print, the look of a page, etc., insert dates, pictures and hyperlinks, view a document, change page margins, print documents.</li>
                                  </ul>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  Microsoft Office is a collection of software programs commonly used in an office environment.In SIIT CCC Courses, We only teaches Microsoft Word, Excel, and PowerPoint. And with that you can easily done :

                                  <ul>
                                      <li>Create text documents with full formatting solutions.</li>
                                      <li>Create mathematical spreadsheets.</li>
                                      <li>Make sophisticated presentations.</li>
                                  </ul>
