<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Adobe_photshop.aspx.cs" Inherits="Adobe_photshop" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <!--/Side NAv -->
                        <h2> About Adobe Photoshop Courses &nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p><br />
                           SIIT institute is the best one in giving the professional Photoshop training . Our training institute is offering complete practical based Photoshop training with our highly qualified Photoshop trainers. SIIT Photoshop Courses covers all fundamental of part of , we also believe in giving high-end & finishing classes for student. We are leading & most popular institute in creating professionals Photoshop designers, who are service his services in national & international companies. This course is perfect for those people who want to do own wok as a freelancer.
                            <br /
                                <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's to learn Adobe photoshop.</font></li>
                                    <li><font style="color: #FF3300"  >Course Duration :</font><font style="color: #CBCBCB"> 1 Months / 3 Months. </font></li>
                                    <li><font style="color: #FF3300"  >Class Mode :</font><font style="color: #CBCBCB"> Regular & Alternate. </font></li>
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this Adobe Photoshop Course you<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          will know helps you to be more productive and to create higher quality images <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          more efficiently. You receive an introduction to editing, retouching, and <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                         enhancing images.</font></li>
                                </ul>
                         </p>

                        <div class="progress-wrap">
                            <h3>Adobe Photoshop Courses Under Demand</h3>
                            <div class="progress">
                        ...
                        <div class="panel-group" id="accordion1">
                              ...
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                        ...
                                        <div class="media-body">
                                             <p><br />
                                               SIIT teaches students enrolling for this Photoshop course at our web designing institute are targeted to have complete control & knowledge over every aspect of image/photo manipulation and retouching techniques. Photoshop allows web designers to produce a wide variety of optimised graphics, including background images, banners, navigation elements and any other images you require on your website. During Photoshop training you will learn how to create and optimise your images for the web. <br /> </p>
                                        </div>
                                  </div>
                              </div>
                            </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  <ul>
                                      <li> Learn a non-destructive retouching workflow, separate an image by spatial frequencies, recontour shadows and highlights.One of the black arts of photographic retouching is how to achieve the impossibly smooth, yet sharply rendered skin, textures and fabrics seen in fashion and beauty images. Photoshop has its own high quality smoothing and sharpening filters, but the two processes tend to be somewhat contradictory.</li>
                                      <li>Photoshop layers are like sheets of stacked acetate. You can see through transparent areas of a layer to the layers below. You move a layer to position the content on the layer, like sliding a sheet of acetate in a stack. You can also change the opacity of a layer to make content partially transparent.You use layers to perform tasks such as compositing multiple images, adding text to an image, or adding vector graphic shapes. You can apply a layer style to add a special effect such as a drop shadow or a glow.</li>
                                  </ul>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseFour1" class="panel-collapse collapse">
                              <div class="panel-body">
                             The Save For Web command in Photoshop allows you to optimize your images for use on the web. Broadband may be allowing us to use larger images online, but it’s still important to remember the visitors who aren’t on broadband and optimize all images on a web site. One vital aspect of a successful web site is its ability to load quickly.JPEG and GIF are the two most common formats used on the web, with the PNG format catching up.                             </div>
                            </div>
                          </div>
