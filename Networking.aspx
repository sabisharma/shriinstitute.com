<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Networking.aspx.cs" Inherits="Networking" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Networking Courses &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p><br />
                           SIIT institute teaches students with comprehensive knowledge to plan, secure, maintain and even troubleshoot various enterprise networks. We have set up higher standards to deliver the best computer networking course.
                            <br /
                                <ul>
