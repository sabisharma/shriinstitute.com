...
<body>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
           ...
           <div class="center wow fadeInDown">
                <h2>Tie-Up Companies :</h2>
                <p class="lead">SIIT provides full placement support to its students in all in its areas of professional education & courses which we are teaching.<br />The main purpose of SIIT is for higher education is to create and transfer knowledge for the welfare of the society.<br />Over the last decades the Institute has emerged as one of the most favoured destination for hiring fresh Talent.<br /> Its endeavors to provide Industry compliant talent and emphasis on Quality, Discipline, Self-Learning, Ethics and Values have borne rich dividends. </p>
                ...
                <div class="features">
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                             <img src="images/logo companies/aon.png" class="img-circle" alt="">
                            <h2>AON Service India Pvt. Ltd</h2>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                             ...
                             <img src="images/logo companies/railtel.jpg" class="img-circle" alt="">
                            <h2>Railtel Corporation of India Ltd.</h2>
                        </div>
                    </div><!--/.col-md-4-->

                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                             <img src="images/logo companies/vsnl1.jpg" class="img-circle" alt="">
                 <h2> Videsh Sanchaar Nigam Ltd.</h2>
                        </div>
                    </div><!--/.col-md-4-->
                
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            <img src="images/logo companies/ecil.jpg" class="img-circle" alt="">
                        <h2>Electronics Corporation of India Ltd.</h2>                         
                        </div>
                    </div><!--/.col-md-4-->

                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            < <img src="images/logo companies/National E gov Division.png" class="img-circle" alt="">
                            <h2>National E-Gov Division</h2>
                        </div>
                    </div><!--/.col-md-4-->

                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                             <img src="images/logo companies/JiNDAL sAw Ltd.jpg" class="img-circle" alt="">
                            <h2>JiNDAL Saw Ltd.</h2>
                        </div>
                    </div>
                     <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                             <img src="images/logo companies/Shyam tyelecom Ltd.jpg" class="img-circle" alt="">
                            <h2>Shyam Telecom Ltd.</h2>
                        </div>
                    </div>
                     <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                             <img src="images/logo companies/Geecab Industries Ltd.jpg" class="img-circle" alt="">
                            <h2>Geecab Industries Ltd.</h2>
                        </div>
                    </div>
                     <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            
                             <img src="images/logo companies/icici bank.jpg" class="img-circle" alt="">
                            <h2>ICICI Bank</h2>
                        </div>
                    </div
