...
<asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" Width="300px" placeholder="Name"  ></asp:TextBox><br />
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            ...
            <div class="center">        
                <h2>Ask For Placement??</h2>
                <p class="lead"> Free Fill-Up The Form & Upload Resume </p>
            </div> 
            <div class="row contact-wrap"> 
                ...
                <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="">
                    <div class="col-sm-5 col-sm-offset-1">
                        ...
                        <div class="form-group">
                            <label>Phone *</label>
                            <asp:TextBox ID="txtphn" CssClass="form-control" runat="server" ></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>Job In :</label>
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="Button2" runat="server" class="btn btn-primary btn-lg" OnClick="Button2_Click" Text="Submit"></asp:Button>
                        </div>
                    </div>
                </form> 
            </div><!--/.row-->
