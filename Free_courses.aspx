<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Free_courses.aspx.cs" Inherits="Free_courses" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Free Courses &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p>
                           SIIT offers course made available, free of charge, for unlimited participation by any and all students interested in the subject matter. SIIT are often offered by highly trained teachers that teach them on their SIIT Free Classes. <br />
                          <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's to learn Computer.</font></li>
                                    <li><font style="color: #FF3300"  >Course Duration :</font><font style="color: #CBCBCB"> 1 Months. </font></li>
                                    <li><font style="color: #FF3300"  >Class Mode :</font><font style="color: #CBCBCB"> Regular. </font></li>
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this Free Computer Course you will 
                                         know all regular use of computer and now you are ready to move for your <br />
                                         specialization. </font></li>
                                </ul>
                         </p>

                        <div class="progress-wrap">
                            <h3>Free Courses Under Demand</h3>
                            <div class="progress">
                        ...
                        <div class="panel-group" id="accordion1">
                          <div class="panel panel-default">
                            <div class="panel-heading active">
                              <h3 class="panel-title">
                                ...
                                1: Basic Computer & Internet Basics
                              ...
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                        ...
                                        <div class="media-body">
                                             <p><br />
                                                 Free Course lead to basic computer & Internet basic is to impart basic level computer appreciation programme and internet basic with more emphasis on hands on training. Initially, the course was conceived as to boost the concept of introducing a course on computer fundamentals, especially for students and for all who donot know a bit about computer. However, the course has gained popularity amongst many more categories. The programme can equip a person to use the computers in day-to-day life for professional and personal use.
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseTwo1" class="panel-collapse collapse">
                              <div class="panel-body">
                                     <div class="media-body">
                                  SIIT institute is the best one in giving the professional Hardware training . Our training institute is offering complete practical based hardware training with our highly qualified hardware trainers. SIIT Hardware Courses covers all fundamental of part of , we also believe in giving high-end & finishing classes for student. We are leading & most popular institute to build professionals Hardware experts, who are service his/her services in national & international companies. This course is perfect for those people who want to do own wok as a freelancer.
                                 </div>
                            </div>
                          </div>
                              </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  Under Free courses, basic Tally program With the fast-changing business scenario, experts in Taxation, Payroll Accounting, Excise, VAT and Service Tax are in high demand. The Tally.ERP9 course is all you need to grow your employment opportunities. This Free Course uses a feature-based approach to introduce students to Accounting on Computers. This step-by-step guide you to handle Accounting, Inventory, Statutory and other specific business roles in different types of businesses. Yes, there is life beyond Accounting.
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseFour1" class="panel-collapse collapse">
                              <div class="panel-body">
                             SIIT institute offers professional Photoshop training under Free Courses. Our training institute is offering complete practical based Photoshop training with our highly qualified Photoshop trainers. SIIT Photoshop Courses covers all fundamental of part of , we also believe in giving high-end & finishing classes for student. We are leading & most popular institute in creating professionals Photoshop designers, who are service his services in national & international companies. This course is perfect for those people who want to do own wok as a freelancer.
                                   </div>
                            </div>
                          </div>
