<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Livhard.aspx.cs" Inherits="Livhard" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Live Computer Hardware Courses &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p><br />
                           SIIT institute teaches students with comprehensive knowledge to plan, secure, maintain and even troubleshoot various enterprise Hardware LIVE. We have set up higher standards to deliver the best computer hardworking course.The basic reason of having students undergo this kind of LIVE training is for students to experience what a real networking environment should be.Real experience of executing a project under the expert guidance. 
                            <br /
                                <ul>
