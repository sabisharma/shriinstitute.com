<%@ Page Language="C#" AutoEventWireup="true" CodeFile="laptop_reparing.aspx.cs" Inherits="laptop_reparing" %>
  ...
  <span style="font-size:22px;cursor:pointer;color: #FF5050; text-decoration: blink;" onclick="openNav()"><i class="fa fa-hand-o-left" aria-hidden="true"></i> Free Demo Classes!</span>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        <h2> About Laptop Repairing Courses &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ValidationGroup="B" OnClick="Button2_Click" Text="Enroll Now!"></asp:Button> </h2> 
                        <p>SIIT offers you this course is fully comprehensive of all the repairing techniques important to repairing laptops of HP, Acer, Lenovo, HCL and many more. We have chip level and card level Laptop Repairing Course syllabus that focus on various repairing aspects. For students interested in gaining knowledge about both, we have designed a combo Laptop Repairing Course as well.
                            <ul>
                                    <li> <font style="color: #FF3300"  >For Us You are :</font><font style="color: #CBCBCB"> A student who want's to learn laptop repairing. </font></li>
                                    <li><font style="color: #FF3300"  >Course Duration :</font><font style="color: #CBCBCB"> 6 Months / 12 Months. </font></li>
                                    <li><font style="color: #FF3300"  >Class Mode :</font><font style="color: #CBCBCB"> Regular & Alternate. </font></li>
                                    <li><font style="color: #FF3300"  >After Course Completion : </font><font style="color: #CBCBCB">After completing this course, you can start earning instantly. After becoming a laptop specialist, you can learn advance computer repair skills which will help you to take a job in any IT firms.</font></li>
                                </ul>
                         </p>

                        <div class="progress-wrap">
                            <h3>Laptop Repairing Courses Under Demand</h3>
                            <div class="progress">
                        ...
                        <div class="panel-group" id="accordion1">
                          <div class="panel panel-default">
                            <div class="panel-heading active">
                              <h3 class="panel-title">
                                ...
                                1: Laptop Basic Hardware And Electronic
                              ...
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                        ...
                                        <div class="media-body">
                                             <p><br />
                                    SIIT teaches a Laptop Repairing basic of Laptop H/W & S/W from basic level to advance level course. It put emphasis on practical training in identification, assembling, dissembling, repairing and configuring Laptops. SIIT keeps the training methodology simple yet effective. Hands-on training is given to the students in the practical lab during Laptop Repairing.
                                                 <br /> </p>
                                        </div>
                                  </div>
                              </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              ...
                              2: Laptop Motherboard Repairing And Soldering Techniques
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                            <div id="collapseTwo1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  In Laptop Repairing courses, SIIT teachers teaches you from the basic motherboard details to the advance level and other depth details of Soldering Techniques which is very useful to the students to sharpen their skills.</div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h3 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseThree1">
                                 3: Reassembling-Disassembling Laptops
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                  <ul>
                                      <li> The assembling of the Laptop is exactly the opposite of disassembling operation.Before Starting assembling the Laptop, SIIT teaches the basic details of plugs, socket , ports etc. and very useful SIIT repairing notes and  practical classes.</li>
                                      <li>The disassembling of the Laptop is exactly the opposite of assembling operation.Before Starting disassembling the Laptop, SIIT teaches you how to disassemble Laptop hardware and by given SIIT repairing notes and  practical classes.</li>
                                  </ul>
                            ...
                            <div id="collapseFour1" class="panel-collapse collapse">
                             ...
                             <ul>
                                ...
                                <li>Software Problem – Software not working, Corrupted Software, VIRUS detection & removal, Detection issues etc. </li>
                                 <li>Troubleshoot each part of Laptops uniquely.</li>
